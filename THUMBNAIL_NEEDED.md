...
These 13 projects currently use placeholder SVGs on the homepage. Replace each with a real screenshot (PNG, ~400px wide) and update the `"image"` path in `projects.json`.

| Project | Current Placeholder | Suggested Screenshot |
|---------|-------------------|---------------------|
| On Dynamical Systems | `placeholder-dynamical-systems.svg` | Treatise page or key diagram |
| SPECTRUM Market Analytics | `placeholder-spectrum.svg` | Dashboard radar chart view |
...
| Problem-Solving & Critical Path Reasoning | `placeholder-problem-solving-cpr.svg` | PSCPR guide sheet |
...
- Nonlinear Population Growth Modeling (`sameforecastnewimage2.jpg`)
