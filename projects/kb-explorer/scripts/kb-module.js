...
const COLORS = {
  ...
  PHYS: '#60b8e0', BIO: '#7bc96f', SFT: '#d98cc0',
  tes: '#607080', quotes: '#a08850', unknown: '#555',
  ai_shared: '#7a8a9a', human_skills: '#e8a040',
  // Agent domains keyed by post-2026-06-15 Agent IDs (were CE/CD/PM/RA/SA/TA)
  ART: '#ff8866', ENG: '#4a90c2', SCI: '#ffcc44', PROF: '#88ddaa',
  WEB: '#cc88ff', PM: '#77aaff', PA: '#00d4aa'
};
