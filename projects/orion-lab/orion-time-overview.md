...
4. **Translunar Injection** — A 0.360 km/s prograde burn at HEO perigee (close to NASA's reported 0.388 km/s / 1,274 ft/s). The orbit start angle is chosen so that perigee velocity naturally aligns with the translunar trajectory — equivalent to selecting the correct launch window.

5. **Translunar Coast** — ~4 days of gravitational coasting toward the Moon.

6. **Lunar Flyby** — Free-return trajectory with a perilune of ~6,500 km (NASA: ~6,600 km).
...
All trajectory parameters were validated against real Artemis II mission data from NASA blogs, press releases, and mission control reports:

| Parameter | Simulation | NASA Reported |
|-----------|-----------|---------------|
| TLI delta-v | 0.360 km/s | 0.388 km/s (1,274 ft/s) |
| HEO apogee | 74,000 km | 74,030 km (46,000 mi) |
| Perilune altitude | ~6,500 km | ~6,600 km (4,100 mi) |
| Mission duration | ~9.1 days | ~10 days |
| Max distance | ~405,000 km | 405,600 km (252,021 mi) |
| TLI timing | ~25 hrs post-launch | T+25h14m |
